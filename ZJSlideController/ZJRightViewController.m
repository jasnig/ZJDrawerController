...
@interface ZJRightViewController ()<UITableViewDelegate, UITableViewDataSource>
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [self.zj_drawerController setupNewCenterViewController:new closeDrawer:YES finishHandler:^(BOOL finished) {
        NSLog(@"切换完成");
    }];
}
